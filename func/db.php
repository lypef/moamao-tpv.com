...
';
		...
		while($row = mysqli_fetch_array($data))
	    {
				...
				<form action="func/producst_add_sale.php" autocomplete="off" method="post">
					...
					<td>
						<div class="col-md-12">
							<div class="col-md-6">
								...
								<input type="text" id="cm_ancho'.$row[9].'" name="cm_ancho'.$row[9].'" placeholder="0" value ="0" min="0" oninput="ancho_cm_pulg('.$row[9].', this.value, '.$row[18].')"/>
							</div>

							<div class="col-md-6">
								<center><span>Alto</span></center>
								<input type="text" id="cm_alto'.$row[9].'" name="cm_alto'.$row[9].'" placeholder="0" value ="0" min="0" oninput="alto_cm_pulg('.$row[9].', this.value, '.$row[18].')" />
							</div>
						</div>
					</td>
					...
					<td>
						<div class="col-md-12">
							<div class="col-md-6">
								<center><span>Ancho</span></center>
								<input type="text" id="pul_ancho'.$row[9].'" name="pul_ancho'.$row[9].'" placeholder="0" value ="0" min="0" oninput="ancho_pulg_cm('.$row[9].', this.value, '.$row[18].')"/>
							</div>

							<div class="col-md-6">
								<center><span>Alto</span></center>
								<input type="text" id="pul_alto'.$row[9].'" name="pul_alto'.$row[9].'" placeholder="0" value ="0" min="0" oninput="alto_pulg_cm('.$row[9].', this.value, '.$row[18].')" />
							</div>
						</div>
					</td>
			...
			<tr>
				<form action="func/producst_add_sale.php" autocomplete="off" method="post">
					<input type="hidden" id="url" name="url" value="'.$_SERVER['REQUEST_URI'].'">
					<input type="hidden" id="product" name="product" value="'.$row[9].'">
					<input type="hidden" id="costo'.$row[9].'" name="costo'.$row[9].'" value="'.$precio_.'">
					<input type="hidden" id="folio" name="folio" value="'.$folio.'">
					<input type="hidden" id="hijo" name="hijo" value="0">
			...
			while($item = mysqli_fetch_array($hijos))
			{
					...
					<form action="func/producst_add_sale.php" autocomplete="off" method="post">
						...
						<td>
							<div class="col-md-12">
								<div class="col-md-6">
									<center><span>Ancho</span></center>
									<input type="text" id="hijos_cm_ancho'.$row[9].'" name="cm_ancho'.$row[9].'" placeholder="0" value ="0" min="0" oninput="ancho_cm_pulg_hijos('.$row[9].', this.value, '.$row[18].')" />
								</div>

								<div class="col-md-6">
									<center><span>Alto</span></center>
									<input type="text" id="hijos_cm_alto'.$row[9].'" name="cm_alto'.$row[9].'" placeholder="0" value ="0" min="0" oninput="alto_cm_pulg_hijos('.$row[9].', this.value, '.$row[18].')" />
								</div>
							</div>
						</td>
						...
						<td>
							<div class="col-md-12">
								<div class="col-md-6">
									<center><span>Ancho</span></center>
									<input type="text" id="hijos_pul_ancho'.$row[9].'" name="pul_ancho'.$row[9].'" placeholder="0" value ="0" min="0" oninput="ancho_pulg_cm_hijos('.$row[9].', this.value, '.$row[18].')"/>
								</div>
				...
				<tr>
					<form action="func/producst_add_sale.php" autocomplete="off" method="post">
						<input type="hidden" id="url" name="url" value="'.$_SERVER['REQUEST_URI'].'">
						<input type="hidden" id="product" name="product" value="'.$row[9].'">
						<input type="hidden" id="costo_hijo'.$row[9].'" name="costo_hijo'.$row[9].'" value="'.$precio_.'">
						<input type="hidden" id="folio" name="folio" value="'.$folio.'">
						<input type="hidden" id="hijo" name="hijo" value="'.$item[0].'">
				   ...
				   <p>Unidades disponibles: '.$stock.' UDS</>
					  ...
					  <form action="func/producst_add_sale_order.php" autocomplete="off" method="post">
						  ...
						  <input type="hidden" id="folio" name="folio" value="'.$folio.'">
							...
							<div class="col-md-12">
								<div class="col-md-6">
									<center><span>Ancho cm</span></center>
									<input type="text" id="cm_ancho'.$row[9].'" name="cm_ancho'.$row[9].'" placeholder="0" value ="0" min="0" oninput="ancho_cm_pulg('.$row[9].', this.value, '.$row[18].')" />
								</div>

								<div class="col-md-6">
									<center><span>Alto cm</span></center>
									<input type="text" id="cm_alto'.$row[9].'" name="cm_alto'.$row[9].'" placeholder="0" value ="0" min="0" oninput="alto_cm_pulg('.$row[9].', this.value, '.$row[18].')" />
								</div>
							</div>
							...
							<div class="col-md-12">
								<br>
								<div class="col-md-6">
									<center><span>Ancho pulgadas</span></center>
									<input type="text" id="pul_ancho'.$row[9].'" name="pul_ancho'.$row[9].'" placeholder="0" value ="0" min="0" oninput="ancho_pulg_cm('.$row[9].', this.value, '.$row[18].')"/>
								</div>

								<div class="col-md-6">
									<center><span>Alto pulgadas</span></center>
									<input type="text" id="pul_alto'.$row[9].'" name="pul_alto'.$row[9].'" placeholder="0" value ="0" min="0" oninput="alto_pulg_cm('.$row[9].', this.value, '.$row[18].')" />
								</div>
							</div>
						  ...
						  <div class="col-md-12">
							  <br>
							  <center><span>Unidades</span></center>
	...
	{
		$data = mysqli_query(db_conectar(),"SELECT p.nombre, p.stock, p.oferta, p.precio_normal, p.precio_oferta, p.foto0, p.foto1, p.foto2, p.foto3, p.id, p.descripcion, p.`tiempo de entrega`, p.`no. De parte`, a.nombre, d.nombre, p.marca, p.loc_almacen, p.cc2, p.vc2, p.l_medida_moldura, p.l_ancho_moldura, p.c_cm_lineal, p.p_cm_lineal FROM productos p, almacen a, departamentos d where p.almacen = a.id and p.departamento = d.id and p.`no. De parte` like '%$txt%' or p.nombre like '%$txt%' or p.descripcion like '%$txt%' or p.marca like '%$txt%'or p.proveedor like '%$txt%' order by p.id asc");
				...
				<form action="func/producst_add_sale.php" autocomplete="off" method="post">
					...
					<td>
						<div class="col-md-12">
							<div class="col-md-6">
								<center><span>Ancho</span></center>
								<input type="text" id="pul_ancho'.$row[9].'" name="pul_ancho'.$row[9].'" placeholder="0" value ="0" min="0" oninput="ancho_pulg_cm('.$row[9].', this.valu, '.$row[18].'e)"/>
							</div>
	...
	function table_sale_products_finaly_ ($folio)
	{
		...
		$data = mysqli_query(db_conectar(),"SELECT v.unidades, if (v.ancho > 0, concat(_p.nombre,' ', ROUND(v.ancho / 2.54, 2 ), ' X ', ROUND(v.alto / 2.54, 2 ), ' PULG'), _p.nombre) as nombre, v.precio, v.id, _p.descripcion, _p.foto0, _p.id, _p.`no. De parte`, _p.marca, _p.stock FROM product_venta v, productos _p WHERE v.product = _p.id and v.folio_venta = '$folio' ");
	...
	{
		$data = mysqli_query(db_conectar(),"SELECT v.unidades, if (v.ancho > 0, concat(_p.nombre,' ', ROUND(v.ancho / 2.54, 2 ), ' X ', ROUND(v.alto / 2.54, 2 ), ' PULG'), _p.nombre) as nombre, v.precio, v.id, _p.descripcion, _p.foto0, _p.id, _p.`no. De parte`, _p.marca, _p.stock FROM product_pedido v, productos _p WHERE v.product = _p.id and  v.folio_venta = '$folio' ");
		$data_ = mysqli_query(db_conectar(),"SELECT v.nombre, c.nombre, f.descuento, f.fecha, f.iva FROM folio_venta f, users v, clients c WHERE f.vendedor = v.id and f.client = c.id and f.folio = '$folio' ");
	...
	function GetPedidoAdeudo ($folio)
	{
		$data = mysqli_query(db_conectar(),"SELECT v.unidades, if (v.ancho > 0, concat(_p.nombre,' ', ROUND(v.ancho / 2.54, 2 ), ' X ', ROUND(v.alto / 2.54, 2 ), ' PULG'), _p.nombre) as nombre, v.precio, v.id, _p.descripcion, _p.foto0, _p.id, _p.`no. De parte`, _p.marca, _p.stock FROM product_pedido v, productos _p WHERE v.product = _p.id and  v.folio_venta = '$folio' ");
		$data_ = mysqli_query(db_conectar(),"SELECT v.nombre, c.nombre, f.descuento, f.fecha, f.iva FROM folio_venta f, users v, clients c WHERE f.vendedor = v.id and f.client = c.id and f.folio = '$folio' ");
		$genericos = mysqli_query(db_conectar(),"SELECT unidades, p_generico, precio, id FROM product_pedido v WHERE p_generico != '' and folio_venta = '$folio'");
	...
	function table_orders()
	{
		...
		while($row = mysqli_fetch_array($data))
	    {
			...
			<td class="item-des">'.str_replace("0:00:00", "", GetFechaText($row[3])).'</td>
	...
	function table_orders_client($id_client)
	{
		$data = mysqli_query(db_conectar(),"SELECT f.folio, u.nombre, c.nombre, f.f_entrega, DATEDIFF(f.f_entrega, NOW()) as dias , s.nombre, f.t_pago FROM folio_venta f, users u, clients c, sucursales s WHERE f.open = 1 and f.pedido = 1 and f.vendedor = u.id and f.client = c.id and f.sucursal = s.id and f.client = $id_client order by f.f_entrega ASC");
		
		$body = '
		<h4><center><b>CLIENTE:</b> '.Return_NombreClient($id_client).'</center></h4>
		...
		<table class="cart table">
			<thead>
				<tr>
					...
					<th class="table-head th-name uppercase">abonos</th>
					<th class="table-head th-name uppercase">adeudo</th>
		...
		while($row = mysqli_fetch_array($data))
	    {
			...
			$total = GetPedidoTotal($row[0]);
			$adeudo = GetPedidoAdeudo($row[0]);
			$abono = $total - $adeudo;
			
			$total_ingresos = $total_ingresos + $total;
			$total_adeudo = $total_adeudo + $adeudo;

			$body = $body.'
			<tr '.$color.'>
			<td class="item-des"><a '.$color.' href="/sale_finaly_report_orderprint.php?folio_sale='.$row[0].'">'.$row[0].'</a></td>
			<td class="item-des"><p '.$color.'>'.$row[1].'</p></td>
			<td class="item-des">'.$row[5].'</td>
			<td class="item-des">'.str_replace("0:00:00", "", GetFechaText($row[3])).'</td>
			<td class="item-des"><center>'.number_format($total,GetNumberDecimales()).'</center></td>
			<td class="item-des"><center>'.number_format($abono,GetNumberDecimales()).'</center></td>
			<td class="item-des"><center>'.number_format($adeudo,GetNumberDecimales()).'</center></td>
			<td class="item-des"><center>'.$row[6].'</center></td>
			<td class="item-des">'.GetStatusPedido($row[0]).'</td>
		...
		<tbody>
		<tr>
		<td style="text-align: center;"><strong>NUMERO DE VENTAS</strong></td>
		<td style="text-align: center;"><strong>TOTAL DE VENTAS</strong></td>
		<td style="text-align: center;"><strong>TOTAL ADEUDADO</strong></td>
		</tr>
		<tr>
		<td style="text-align: center;">'.$cont.'</td>
		<td style="text-align: center;">$ '.number_format($total_ingresos,GetNumberDecimales()).' MXN</td>
		<td style="text-align: center;">$ '.number_format($total_adeudo,GetNumberDecimales()).' MXN</td>
		</tr>
		</tbody>
		</table>
';
 ...
 ">
	...
	function select_client_orders ($pagina)
	{
		$TAMANO_PAGINA = 5;
		...
		$body = '
		<div class="compare-wraper mt-30">
				<form class="header-search-box" action="orders_select_client.php">
					<div>
						<input type="hidden" name="pagina" id="pagina" value="1">
						<input type="text" placeholder="Buscar" name="search" autocomplete="off" style="
				  width: 100%;
		...
		while($row = mysqli_fetch_array($data))
	    {
			...
			<div class="col-md-12">
				<a href="/orders_client.php?id='.$row[0].'" class="button extra-small button-black mb-20"><span> Seleccionar</span> </a>
			</div>
	...
	function select_client_orders_search ($txt, $pagina)
	{
		$TAMANO_PAGINA = 5;
	...
	function table_orders_modal_two ()
	{
	...
	function returnVc2 ($id)
	{
		$data = mysqli_query(db_conectar(),"SELECT vc2 FROM productos WHERE `id` = $id ");
		$r = 0.0;
		while($row = mysqli_fetch_array($data))
	    {
	        $r = $row[0];
